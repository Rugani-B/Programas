...
class Item(db.Model):
  id = db.Column(db.Integer, primary_key = True)    
  song_id = db.Column(db.Integer, db.ForeignKey('song.id')) # cada Item tem 1 Song
  playlist_id = db.Column(db.Integer, db.ForeignKey('playlist.id')) # cada Item é de uma playlist.
